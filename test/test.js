...
describe('#findDuplicates()', function () {
  it('should return [] with an empty array', function () {
    const arr = []
    const result = JSON.stringify(findDuplicates(arr))
    const expected = JSON.stringify([])
    expect(result).to.equal(expected)
  })

  it('should return [] when there are no repetitions', function () {
  ...
  it('should return the indices of one repeated element starting at index 0', function () {
  ...
  it('should return the indices of one repeated element starting after index 0', function () {
  ...
  it('should return the indices of many sandwiched elements starting at index 0', function () {
  ...
  it('should return the indices of many sandwiched elements starting after index 0', function () {
  ...
  it('should return the indices of many contiguous elements starting at index 0', function () {
  ...
  it('should return the indices of many contiguous elements starting after index 0', function () {
  ...
  it('should return the indices of many interwoven elements starting at index 0', function () {
  ...
  it('should return the indices of many interwoven elements starting after index 0', function () {
  ...
  it('should only return the first set of matches when stopAtFirstSet is true', function () {
    ...
    const result = JSON.stringify(findDuplicates(arr, true))
